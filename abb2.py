...
MODEL_WEIGHT_FILE = "model/abb2.model"
...
class AbbRNN:
    ...
    def _build(self):
        ...
        word_emb_layer = Embedding(self.w2v.vocab_size + 1, self.w2v.vector_size,
                                   ...
                                   trainable=False, name="word_emb")

        char_rnn_layer = LSTM(RNN_DIM, use_bias=False,
                              return_sequences=True, name="char_rnn_layer")
        word_rnn_layer = LSTM(RNN_DIM, use_bias=False,
                              return_sequences=True, name="word_rnn_layer")
        ...
        char_rnn_out = char_rnn_layer(char_emb)
        word_rnn_out = word_rnn_layer(word_emb)
        out = out_layer(concatenate([char_rnn_out, word_rnn_out]))
